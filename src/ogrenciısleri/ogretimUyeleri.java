 ...
 * @author Gokay
 */
public class ogretimUyeleri extends dosyaSoyut implements anaIslemler{
    ...
    public void kaydet(String ad, String soyad, int ogrno) {
         PrintWriter out = null;
                            ...
                            this.soyad=soyad;
                            this.ogrno=ogrno;
                            out = new PrintWriter(new BufferedWriter(new FileWriter(path+"\\src\\ogrenciısleri\\ogretimUyesiListesi.txt", true)));
