 ...
 * @author Gokay
 */
public class ProjeNotlari extends NotlarSoyut implements NotGormeArayuz{
     
     @Override
        public void NotListesiGoruntule() 
    {
            try (BufferedReader br = new BufferedReader(new FileReader(path+"\\src\\ogrenciısleri\\projeNotlari.txt"))) {
                ...
                System.out.println("**********Proje Notlari***********");
     ...
     public void ogrencininNotunuGor (int ogrno){
            ...
            String[] not;
            try{
            File f = new File(path+"\\src\\ogrenciısleri\\projeNotlari.txt");
            ...
            if( !(line=br.readLine()).startsWith(a)){}
                ...
                not=line.split(" ");
                System.out.println("Proje Notun: "+not[3]);
                break;
            }
            } 
